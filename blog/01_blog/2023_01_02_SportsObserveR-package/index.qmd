...
Recently I have been looking to create more mathematical models of NBA statistics. However the process of scrapping and downloading data has become more tedious as the models scale. To save myself time, and lines of code I am creating a package in R to do a lot of the heavy lifting for me. 

To start I will only be creating two functions:
