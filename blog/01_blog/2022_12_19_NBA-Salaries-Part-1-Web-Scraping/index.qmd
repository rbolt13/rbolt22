...
This post exhibits a scraping function that saves and cleans data from [ESPN - NBA Players Salaries](http://www.espn.com/nba/salaries), as well as some simple data visuals of NBA Salaries. 
...
1. Use `rbing()` to merge all the data. 
